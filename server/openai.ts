      ...
      try {
        const analysisResponse = await openai.chat.completions.create({
          ...
          messages: [
            {
              role: "system",
              content: `당신은 음성 메시지 텍스트를 분석해서 사용자가 YouTube 영상을 원하는지 또는 나중에 알림을 원하는지 파악하는 AI입니다. 
              오직 YouTube와 나중에알림 관련 요청만 감지하고 JSON으로 응답하세요:
              ...
              YouTube의 경우 검색할 키워드를 정확히 추출하고, 나중에알림의 경우 원본 메시지를 reminderText로 저장하세요.
