  ...
  return (
    ...
    >
      ...
      <div 
        ...
        ref={chatScrollRef}
        className="flex-1 overflow-y-auto overflow-x-hidden px-1.5 py-2 space-y-0.5 min-h-0 overscroll-behavior-y-contain overscroll-behavior-x-none pb-32 scrollbar-thin scrollbar-thumb-purple-300 scrollbar-track-gray-100 relative w-full"
                ...
                <div className={cn("flex w-full", isMe ? "justify-end" : "justify-start")}>
                  <div 
                    ...
                    className={cn(
                      ...
                      isMe ? "space-x-1 flex-row-reverse space-x-reverse" : "space-x-2",
