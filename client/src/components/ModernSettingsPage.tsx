  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      <div className="flex-1 overflow-y-auto scrollbar-thin bg-gray-50">
        <div className="max-w-2xl mx-auto p-4 pt-[calc(1.7rem+env(safe-area-inset-top))] space-y-4 min-h-full pb-24">
          {/* 헤더 */}
              ...
              <div className="flex items-center space-x-4">
                <div className="relative cursor-pointer" onClick={() => setShowProfilePhotoUpload(true)}>
                  <InstantAvatar 
                    ...
                    className="w-16 h-16"
                  />
                  <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-purple-600 rounded-full flex items-center justify-center hover:bg-purple-700 transition-colors">
          ...
          <div className="space-y-2">
            <h4 className="text-sm font-semibold text-gray-700 px-2 mb-3">계정 설정</h4>
            
            <Card 
              className="bg-white border border-gray-200 hover:border-purple-300 transition-all cursor-pointer group"
          ...
          {/* AI 기능 섹션 */}
          <div className="space-y-2">
            <h4 className="text-sm font-semibold text-gray-700 px-2 mb-3">AI 기능</h4>
          ...
          {/* 일반 설정 섹션 */}
          <div className="space-y-2">
            <h4 className="text-sm font-semibold text-gray-700 px-2 mb-3">일반</h4>
          ...
          {/* 지원 섹션 */}
          <div className="space-y-2">
            <h4 className="text-sm font-semibold text-gray-700 px-2 mb-3">지원</h4>
