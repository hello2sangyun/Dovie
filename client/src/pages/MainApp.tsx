    ...
    <div className="fixed inset-0 bg-white dark:bg-gray-900">
      ...
      <div className="hidden lg:flex h-full">
        ...
        <div className="w-96 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 flex flex-col">
          {/* Header */}
          <div className="p-4 pt-[calc(2rem+env(safe-area-inset-top))] border-b border-gray-200 dark:border-gray-700 purple-gradient">
      ...
      <div className="lg:hidden h-full flex flex-col">
        ...
        {!showMobileChat && (
          <div className="flex-shrink-0 purple-gradient p-4 pt-[calc(2rem+env(safe-area-inset-top))] text-white fixed top-0 left-0 right-0 z-50 lg:hidden">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
